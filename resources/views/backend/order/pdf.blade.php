...
<style type="text/css">
  ...
  <div class="invoice-header">
    <div class="float-left site-logo">
      <img src="{{public_path('backend/img/logo.png')}}" alt="" style="max-height: 60px;">
    </div>
    ...
    <table class="table table-bordered table-stripe">
      ...
      @endphp
        <tr>
          ...
          <td><span>NGA{{number_format($cart->price,2)}}</span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col"> <span>NGA{{number_format($order->sub_total,2)}}</span></th>
        </tr>
      ...
      @endif --}}
        <tr>
          ...
          <th><span>NGA{{number_format($shipping_charge->isNotEmpty() ? $shipping_charge[0] : 0, 2)}}</span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
          ...
          <th>
            <span>
                NGA{{number_format($order->total_amount,2)}}
            </span>
          </th>
        </tr>
      </tfoot>
