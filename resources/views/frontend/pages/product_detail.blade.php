...
@endsection
@section('title','Saif Store || PRODUCT DETAIL')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">N{{number_format($after_discount,2)}}</span><s>N{{number_format($product_detail->price,2)}}</s> </p>
											...
											<div class="product-buy">
												...
												<p class="cat">Category :<a href="{{ $product_detail->cat_info ? route('product-cat',$product_detail->cat_info->slug) : '#' }}">{{ $product_detail->cat_info->title ?? 'N/A' }}</a></p>
												@if($product_detail->sub_cat_info)
												<p class="cat mt-1">Sub Category :<a href="{{route('product-sub-cat',[$product_detail->cat_info->slug ?? 'none', $product_detail->sub_cat_info->slug])}}">{{$product_detail->sub_cat_info->title}}</a></p>
												@endif
																...
																<div class="ratting-main">
																	...
																	<div class="single-rating">
																		...
																		<div class="rating-des">
																			<h6>{{$data->user_info->name ?? 'Anonymous'}}</h6>
																			<div class="ratings">
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @endphp
                                            <span class="old">N{{number_format($data->price,2)}}</span>
                                            <span>N{{number_format($after_discount,2)}}</span>
                                        </div>
