...
// Paystack Routes
    Route::get('paystack/initialize/{order_id}', [PaystackController::class, 'initializeTransaction'])->name('paystack.initialize')->middleware('user');
    Route::get('paystack/payment-data/{order_id}', [PaystackController::class, 'getPaymentData'])->name('paystack.payment-data')->middleware('user');
