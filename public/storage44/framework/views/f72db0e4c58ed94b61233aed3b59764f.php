<?php $__env->startSection('title','Saif Store || PRODUCT PAGE'); ?>
                                    ...
                                    <?php $__currentLoopData = $recent_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                ?>
                                                <p class="price"><del class="text-muted">N<?php echo e(number_format($product->price,2)); ?></del>   N<?php echo e(number_format($org,2)); ?>  </p>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mikiyate/saif/resources/views/frontend/pages/product-grids.blade.php ENDPATH**/ ?>