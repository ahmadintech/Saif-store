                        ...
                        <div class="col-lg-4 col-12">
                            <div class="order-details">
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <ul>
										    <li class="order_subtotal" data-price="<?php echo e(Helper::totalCartPrice()); ?>">Cart Subtotal<span>N<?php echo e(number_format(Helper::totalCartPrice(),2)); ?></span></li>
                                            <li class="shipping">
                                                Shipping Cost
                                                <?php if(count(Helper::shipping())>0 && Helper::cartCount()>0): ?>
                                                    <select name="shipping" class="nice-select">
                                                        ...
                                                        <option value="<?php echo e($shipping->id); ?>" class="shippingOption" data-price="<?php echo e($shipping->price); ?>"><?php echo e($shipping->type); ?>: N<?php echo e($shipping->price); ?></option>
                                            ...
                                            <li class="coupon_price" data-price="<?php echo e(session('coupon')['value']); ?>">You Save<span>N<?php echo e(number_format(session('coupon')['value'],2)); ?></span></li>
                                            <?php endif; ?>
                                            <?php
                                            ...
                                            ?>
                                            <?php if(session('coupon')): ?>
                                                <li class="last"  id="order_total_price">Total<span>N<?php echo e(number_format($total_amount,2)); ?></span></li>
                                            <?php else: ?>
                                                <li class="last"  id="order_total_price">Total<span>N<?php echo e(number_format($total_amount,2)); ?></span></li>
                                            <?php endif; ?>
                                        </ul>
            ...
            <div class="inner-top">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12">
                        ...
                        <div class="inner">
                            <h4>Newsletter</h4>
                            <p> Subscribe to our newsletter and get <span>1%</span> off your first purchase</p>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mikiyate/saif/resources/views/frontend/pages/checkout.blade.php ENDPATH**/ ?>