<?php $__env->startSection('title','Saif Store | HOME PAGE'); ?>
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <div class="product-price">
                                                ...
                                                ?>
                                                <span>N<?php echo e(number_format($after_discount,2)); ?></span>
                                                <del style="padding-left:4%;">N<?php echo e(number_format($product->price,2)); ?></del>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <?php $__currentLoopData = $product_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="single-product">
                            ...
                            <div class="product-content">
                                <h3><a href="<?php echo e(route('product-detail',$product->slug)); ?>"><?php echo e($product->title); ?></a></h3>
                                <div class="product-price">
                                    <span class="old">N<?php echo e(number_format($product->price,2)); ?></span>
                                    <?php
                                    $after_discount=($product->price-($product->price*$product->discount)/100)
                                    ?>
                                    <span>N<?php echo e(number_format($after_discount,2)); ?></span>
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        <p class="price with-discount">N<?php echo e(number_format($product->discount,2)); ?></p>
                                    </div>
                                </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="quickview-content">
                                        ...
                                        <?php
                                            $after_discount=($product->price-($product->price*$product->discount)/100);
                                        ?>
                                        <h3><small><del class="text-muted">N<?php echo e(number_format($product->price,2)); ?></del></small>    N<?php echo e(number_format($after_discount,2)); ?>  </h3>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mikiyate/saif/resources/views/frontend/index.blade.php ENDPATH**/ ?>